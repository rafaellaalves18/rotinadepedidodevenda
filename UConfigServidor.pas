...
begin
   ...
   begin
     Application.MessageBox( 'Conexão de Banco de Dados realizada', 'ATENÇÃO', MB_ICONQUESTION);
    /// Application.Terminate;
   end
   else
   begin
     Application.MessageBox('Não foi possivel conectar no Banco de Dados', 'ATENÇÃO', MB_ICONQUESTION);
     exit;
   end;
end;
